import { IonButton, IonButtons, IonCheckbox, IonChip, IonContent, IonHeader, IonIcon, IonInput, IonItem, IonItemDivider, IonItemGroup, IonLabel, IonList, IonListHeader, IonModal, IonPage, IonRadio, IonRadioGroup, IonSearchbar, IonSelect, IonSelectOption, IonText, IonTextarea, IonTitle, IonToolbar } from '@ionic/react';
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {formStep >= 1 &&
              <section className={formStep == 1 ? "showSection" : "hideSection"}>
                ...
                <IonItemGroup className='prescription_section'>
                  <IonItem lines='none' >
                    <IonLabel className="prescription_label" position="stacked">Exercise</IonLabel>
