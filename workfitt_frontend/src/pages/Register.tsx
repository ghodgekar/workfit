        ...
        {isLoadingResult ?
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <IonItem lines='none'>
              ...
              <IonInput type="number" className="prescription_input" placeholder='Enter Mobile No. Here....'  {...register("doctor_mobile", { required: true, pattern: /^\d{10}$/, valueAsNumber: true, })} />
            </IonItem>
