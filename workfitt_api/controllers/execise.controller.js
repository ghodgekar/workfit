...
exports.exerciseByDate = async (req) => {
    try {
        ...
        let query = `SELECT presc.prescription_id, presc.prescription_link, presc.patient_id, pt.patient_name, ext.exercise_name, ext.isCompleted,ext.exercise_track_id 
